exports.gerarEmailEndereco = (url) => {
    return `
    <!DOCTYPE html>
										...
										<tbody>
											<tr>
												<td class="column column-1"
													style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 50px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
													width="100%">
															...
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><img alt="I'm an image"
																		src="https://festum-app.vercel.app/static/media/logo.e6123ff97d6f66e07b2a.png"
																		style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;"
																		title="I'm an image" width="120" /></div>
															</td>
														</tr>
													</table>
												</td>
												...
												<td class="column column-1"
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px; letter-spacing: 1px;">
																			<strong>EMAIL DE CONFIRMAÇÃO DE
																				ENDEREÇO</strong></p>
																	</div>
																</div>
															</td>
																...
																<div style="font-family: sans-serif">
																	...
																	<div class=""
																		...
																		<p
																			...
																			Clique no botão abaixo para confirmar seu
																			endereço de email. Se você não solicitou
																			este email por favor ignore-o.</p>
																	</div>
													...
													<table border="0" cellpadding="10" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div align="center" class="alignment">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:42px;width:184px;v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]-->
																	<a href="${url}">
                                                                    <div
																		...
																		<span
																			style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
																				style="margin: 0; word-break: break-word; line-height: 32px;">Confirmar
																				meu email</span></span></div>
...
exports.gerarEmailRedefinicaoDeSenha = (url) => {
	return `
    <!DOCTYPE html>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px; letter-spacing: 1px;">
																			<strong>EMAIL DE REDEFINIÇÃO DE
																				SENHA</strong></p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	...
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">
																			Clique no botão abaixo para redefinir sua 
																			senha. Se você não solicitou
																			este email por favor ignore-o.</p>
																	</div>
															...
															<td class="pad">
																<div align="center" class="alignment">
                                                                    ...
                                                                    <div
																		...
																		<span
																			style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
																				style="margin: 0; word-break: break-word; line-height: 32px;">Redefinir minha senha</span></span></div>
																	<!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
																</div>
                                                                </a>
															</td>
...
exports.gerarEmailOrcamento = (nome, email, telefone, mensagem) => {
	return `
		<!DOCTYPE html>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span style="font-size:18px;"><strong>SOLICITAÇÃO
																					DE ORÇAMENTO</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			Um cliente solicitou um orçamento por email
																			pelo formulário de orçamento na pagina da
																			sua loja.</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
																		<p
																			style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 19.2px; letter-spacing: 1px;">
																			<strong>INFORMAÇÕES DO FORMULÁRIO:</strong>
																		</p>
																	</div>
																</div>
															</td>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		style="font-size: 12px; font-family: Arial, Helvetica, sans-serif; mso-line-height-alt: 24px; color: #555555; line-height: 2;">
																		<ul
																			style="line-height: 2; mso-line-height-alt: 24px; letter-spacing: normal; font-size: 14px;">
																			<li style="text-align: left;"><strong>NOME
																					DO CLIENTE:</strong>  ${nome}</li>
																			<li style="text-align: left;">
																				<strong>EMAIL: </strong>  ${email}</li>
																			<li style="text-align: left;">
																				<strong>TELEFONE: </strong>  ${telefone}</li>
																			<li style="text-align: left;">
																				<strong>MENSAGEM: </strong>  ${mensagem}</li>
																		</ul>
																	</div>
																</div>
															</td>
